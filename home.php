...
get_header(); 
?>
 <section class="banner__section" style="background-image: url(<?php echo get_bloginfo('template_directory')?>/dist/img/bgd.png);">
            <div class="container">
                ...
                <div class="resources__wrapper">
                    <div class="resources__box-content">
                        ...
                        <div class="resources__image">
                            <img src="<?php echo get_bloginfo('template_directory')?>/dist/img/res_icon.png" alt="">
                        </div>
                    ...
                    <div class="resources__box-content">
                        <div class="resources__box-width">
                        <div class="resources__image">
                            <img src="<?php echo get_bloginfo('template_directory')?>/dist/img/res_icon_gr.png" alt="">
                        </div>
                    ...
                    <div class="resources__box-content">
                        <div class="resources__box-width">
                        <div class="resources__image">
                            <img src="<?php echo get_bloginfo('template_directory')?>/dist/img/res_icon_custom.png" alt="">
                        </div>
                    ...
                    <div class="resources__box-content">
                        <div class="resources__box-width">
                        <div class="resources__image">
                            <img src="<?php echo get_bloginfo('template_directory')?>/dist/img/res_iconn.png" alt="">
                        </div>
                    ...
                    <div class="resources__box-content">
                        <div class="resources__box-width">
                        <div class="resources__image">
                            <img src="<?php echo get_bloginfo('template_directory')?>/dist/img/res_icon_deal.png" alt="">
                        </div>
                    ...
                    <div class="resources__box-content">
                        <div class="resources__box-width">
                        <div class="resources__image">
                            <img src="<?php echo get_bloginfo('template_directory')?>/dist/img/res_icon_security.png" alt="">
                        </div>
        ...
        <section id="technologies" class="techno__section" style="background-image: url(<?php echo get_bloginfo('template_directory')?>/dist/img/technoss.png);">
            <div class="container">
    ...
    <section id="funktioniert" class="funktion__section" style="background-image: url(<?php echo get_bloginfo('template_directory')?>/dist/img/technoss-rot.png);">
        <div class="container">
    ...
    <section id="contactusf" class="freee__section" style="background-image: url(<?php echo get_bloginfo('template_directory')?>/dist/img/bgd.png);">
        <div class="container">
